...
export const AUTHOR_BY_GITHUB_ID_QUERY = defineQuery( //to get the author details via github id
    `*[_type == 'author' && id == $id][0]{
        _id,id,name,username,email,image,bio
    }`
)

export const AUTHOR_BY_ID_QUERY = defineQuery( //to get author details via author's id
...
//to get the startups of the particular author
...
// the query to get the playlists (startup of the year etc)
